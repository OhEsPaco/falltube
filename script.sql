CREATE TABLE `video` (
  `videoId` varchar(45) CHARACTER SET utf8 NOT NULL,
  `etag` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `publishedAt` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `channelId` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `categoryId` varchar(45) CHARACTER SET utf8 DEFAULT NULL,
  `defaultAudioLanguage` varchar(45) CHARACTER SET utf8 DEFAULT NULL,
  `duration` varchar(45) CHARACTER SET utf8 DEFAULT NULL,
  `dimension` varchar(45) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `projection` varchar(45) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE `comments` (
  `commentId` varchar(45) CHARACTER SET utf8 NOT NULL,
  ...
  `authorUrl` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
